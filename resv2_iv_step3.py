...
def run(trainr,validr,idx,name):
    ...
    for epoch in range(20):
        ...
        if state['test_accuracy'] > best_accuracy:
            ...
            torch.save(model.state_dict(), os.path.join('/home/dsl/all_check/aichallenger/ai_chanellger/se_step3', idx+'.pth'))
        with open(os.path.join('/home/dsl/all_check/aichallenger/ai_chanellger/se_step3', idx+'.json'),'w') as f:
