...
dataset_dir = 'D:/deep_learn_data/ai_chellenger/class_plant_step1/train'

# State where your log file is at. If it doesn't exist, create it.
log_dir = './trained'

# State where your checkpoint file is
checkpoint_file = 'D:/deep_learn_data/check/inception_v3_2016_08_28/inception_v3.ckpt'
...
file_pattern = 'plants_%s_*.tfrecord'
...
def get_split(split_name, dataset_dir, file_pattern=file_pattern, file_pattern_for_counting='plants'):
    '''
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        with slim.arg_scope(inception_v3.inception_v3_arg_scope()):
            logits, end_points = inception_v3.inception_v3(images, num_classes=dataset.num_classes, is_training=True)
