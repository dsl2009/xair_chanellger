...
test_data_loader = DataLoader(imagenet_data, batch_size=8, shuffle=True)
model = inception_v3(num_classes=1000, pretrained=None, aux_logits=True)
model.load_state_dict(torch.load('D:/deep_learn_data/check/inception_v3_google-1a9a5a14.pth'))
