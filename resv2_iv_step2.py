...
def run(trainr,validr,name,cls_num,idx):
    ...
    for epoch in range(60):
        ...
        if state['test_accuracy'] > best_accuracy:
            ...
            torch.save(model.state_dict(), os.path.join('/home/dsl/all_check/aichallenger/ai_chanellger/se_step2', idx+'.pth'))
        with open(os.path.join('/home/dsl/all_check/aichallenger/ai_chanellger/se_step2', idx+'.json'),'w') as f:
